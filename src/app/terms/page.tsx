"use client"; // Ensure this is at the top for a Client Component

export default function TermsAndConditions() {
  return (
    <div className="w-screen mx-auto p-4 py-40 text-white bg-black">
      <h1 className="text-3xl font-bold text-center mb-4">
        Terms & Conditions
      </h1>
      <p className="text-gray-700">Last updated on 31-12-2024 20:38:10</p>
      <div className="mt-6 space-y-4">
        <p>
          These Terms and Conditions, along with privacy policy or other terms
          (“Terms”) constitute a binding agreement by and between ADITYA RAJ,
        ...
        <h2 className="text-2xl font-semibold">
          Intellectual Property & Unauthorized Use
        </h2>
        <ul className="list-disc ml-6 space-y-2">
          <li>
        ...
        <ul className="list-disc ml-6 space-y-2">
          ...
          <li>
            ...
            in case we are not able to provide the Service.
          </li>
          <li>
            The timelines for such return and refund will be according to the
            specific Service you have availed or within the time period provided
            in our policies (as applicable).
          </li>
          <li>
